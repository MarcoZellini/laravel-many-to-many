                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="fw-bold">{{ $technology->name }}</h3>
                            <p>Technology Number: # {{ $technology->id }}</p>
                        </div>
                        <div class="card-body">
                            <p>
                                {{-- {{ $type->description }} --}}
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalTitleId-{{ $technology->id }}">Deleting technology</h5>
